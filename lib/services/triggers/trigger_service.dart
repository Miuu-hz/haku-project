...
class TriggerService {
  ...
  Future<TriggerEvent?> triggerMorning() async {
    return await _chargingTrigger.generateMorningNotification();
  }
  ...
  Future<ManagerSummaryResult> runManagerSummary() async {
    return await _managerSummary.analyze();
  }
